  ...
  return (
    ...
    <nav className="navbar w-full h-[56px] md:h-[72px] bg-white p-[4px] sm:p-0 sm:px-[24px] flex items-center justify-between shadow-xl flex-grow-1">
      ...
      <div className="log flex gap-2  text-[14px]  ">
        ...
        <div className="cart flex justify-center items-center  w-[49px] cursor-pointer">

          {datails.cartIcon}

        </div>

        <div className="login hidden md:flex justify-center items-center cursor-pointer">
          
          {datails.loginBtn}

          </div>

        <div className="signup bg-black text-white hidden md:flex justify-center items-center font-semibold cursor-pointer">
