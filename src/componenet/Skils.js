...
const Skils = ({ skil }) => {
    ...
    return (
        <main className="py-[0px]">
            ...
            <div className="domine  text-black mx-[24px]  relative mt-5">
                <div className="fort flex  sm:overflow-x-scroll scroll-smooth text-black  flex-col sm:gap-3 sm:flex-row  ">
                ...
                <div className="arr  arr-1 hidden sm:flex absolute  justify-center items-center left-0 p-1 text-blue-800 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-6 h-6 `} onClick={() => handleScrollThree('left')}>
                ...
                <div className="arr arr-1 absolute hidden sm:flex   justify-center items-center right-0 p-1  rounded-full   text-blue-900">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-6 h-6 `} onClick={() => handleScrollThree('right')}>
                    ...
                    return (
                        <div className={`cou ${isVisible ? 'block' : 'hidden'}`} key={index}>
                            <div className="relative mx-[24px]">
                                ...
                                <div className="arr absolute flex justify-center items-center left-0 p-1  bg-white text-black rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-6 h-6 `} onClick={() => handleScroll(index, 'left')}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" />
                                    </svg>
                                </div>
                                <div className="arr absolute flex justify-center items-center right-0 p-1  bg-white text-black rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-6 h-6 `} onClick={() => handleScroll(index, 'right')}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                                    </svg>
                                </div>
                            </div>
                            <div className="con__two ">
                                ...
                                <div className="arr absolute flex justify-center items-center left-0 p-1 bg-black text-white  rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-6 h-6 `} onClick={() => handlescrollTwo(index, 'left')}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" />
                                    </svg>
                                </div>
                                <div className="arr absolute flex justify-center items-center right-0 p-1 bg-black text-white rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-6 h-6 `} onClick={() => handlescrollTwo(index, 'right')}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                                    </svg>
                                </div>
